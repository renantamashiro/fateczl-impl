...
#### Simulações
![lista-estatica](./diagrams/lista-estatica.png)
...
#### Simulações
![lista-circular](./diagrams/lista-circular.png)
...
#### Simulações
![fila-prioridades](./diagrams/fila-prioridades.png)
...
#### Simulações
![fila-circular](./diagrams/fila-circular.png)
...
#### Simulações
![lista-ligada](./diagrams/lista-encadeada.png)
