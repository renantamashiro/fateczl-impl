...
public class Test {
    ...
    public static void testAddAnyPosition(ListTemperature lt) {
        ...
        System.out.println("A lista está vazia? " + lt.isEmpty());
        System.out.println("Temperatura a ser adicionada no final: " + 148.00 + "; posição: 0" + "\n");
        ...
        System.out.println("A lista está vazia? " + lt.isEmpty());
        System.out.println("Temperatura a ser adicionada no final: " + 85.00 + "; posição: 1" + "\n");
        ...
        System.out.println("A lista está vazia? " + lt.isEmpty());
        System.out.println("Temperatura a ser adicionada no final: " + 0.00 + "; posição: 1" + "\n");
